...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SDN 01 Bebidas</h2>
            <p class="text-center">Alamat :  Jln. Parawisata Lemor, Bebidas, Kec. Wanasaba, Kab. Lombok Timur Prov. Nusa Tenggara Barat</p>
